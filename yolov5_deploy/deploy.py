...
cooldown_timer = None
cooldown_duration = 5  # Cooldown duration in
...
def video_feed():
    ...
    return Response(main(vid_path=CameraInput.MAIN_WEB_CAM, vid_out="default_out.mp4"),
...
if __name__ == "__main__":
    ...
    main(vid_path=CameraInput.MAIN_WEB_CAM, vid_out="default_out.mp4")
